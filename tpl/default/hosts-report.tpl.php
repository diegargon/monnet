            ...
            <?php foreach ($tdata['hosts'] as $host): ?>
                <tr>
                    <?php foreach ($tdata['keysToShow'] as $key): ?>
                        ...
                        ?>
                            <img class="hosts-online" src="tpl/<?= $cfg['theme']?>/img/green2.png" alt="online_status" title="On">
                        <?php
                        elseif ($key === 'online' && (int) $host['online'] === 0):
                        ?>
                            <img class="hosts-offline" src="tpl/<?= $cfg['theme']?>/img/red2.png" alt="online_status" title="Off">
                        <?php
                        else:
                            echo $host[$key] ?? '.';
                        endif;
