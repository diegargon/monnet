    ...
    <div class="form_container">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" id="networkName" name="networkName"  size="32" maxlength="255" required value="<?= !empty($tdata['networkName']) ? $tdata['networkName'] : null ?>"></td>
            </tr>
            <tr>
                <td><label for="network"><?= $lng['L_NETWORK'] ?></label></td>
                <td><input type="text" id="network" name="network" size="13" maxlength="13" required value="<?= !empty($tdata['network']) ? $tdata['network'] : null ?>"></td>
            </tr>
            <tr>
                <td><label for="network_cidr">CIDR</label></td>
                <td><input type="text" id="network_cidr" name="networkCIDR" size="2" maxlength="2" required value="<?= !empty($tdata['network_cidr']) ? $tdata['network_cidr'] : null ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="network_vlan" name="networkVLAN" size="5" maxlength="5" required value="<?= !empty($tdata['network_vlan']) ? $tdata['network_vlan'] : 1 ?>"></td>
            </tr>
        </table>
