        ...
        <div class="section hidden-section" id="play<?= $playIndex ?>_task<?= $taskIndex ?>">
            ...
            ?>
                <div class="flex">
                    ...
                    <?php
                        !empty($host_result['changed']) && (var_export($host_result['changed'], true) == "true") ? print '  [Changed]' : null;
                        !empty($host_result['failed']) && (var_export($host_result['failed'], true) == "true") ? print '  [Failed]' : null;
                        !empty($host_result['ignored']) && (var_export($host_result['ignored'], true) == "true") ? print '  [Ignored]' : null;
                        !empty($host_result['rescued']) && (var_export($host_result['rescued'], true) == "true") ? print '  [Rescued]' : null;
                        !empty($host_result['skipped']) && (var_export($host_result['skipped'], true) == "true") ? print '  [Skipped]' : null;
                        !empty($host_result['unreachable']) && (var_export($host_result['unreachable'], true) == "true") ? print '  [Unreachable]' : null;
                    ?>
                </div>
